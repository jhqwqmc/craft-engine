...
public final class FireworkStarModelReader implements SimplifiedModelReader {
    public static final FireworkStarModelReader INSTANCE = new FireworkStarModelReader();

    private FireworkStarModelReader() {}
