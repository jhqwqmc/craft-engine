...
public class PlayTotemAnimationFunction<CTX extends Context> extends AbstractConditionalFunction<CTX> {
    ...
    public static <CTX extends Context> FunctionFactory<CTX, PlayTotemAnimationFunction<CTX>> factory(java.util.function.Function<Map<String, Object>, Condition<CTX>> factory) {
    ...
    private static class Factory<CTX extends Context> extends AbstractFactory<CTX, PlayTotemAnimationFunction<CTX>> {
        ...
        @Override
        public PlayTotemAnimationFunction<CTX> create(Map<String, Object> arguments) {
