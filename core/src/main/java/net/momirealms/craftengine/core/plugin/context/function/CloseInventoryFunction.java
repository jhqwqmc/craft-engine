...
public class CloseInventoryFunction<CTX extends Context> extends AbstractConditionalFunction<CTX> {
    ...
    public static <CTX extends Context> FunctionFactory<CTX, CloseInventoryFunction<CTX>> factory(java.util.function.Function<Map<String, Object>, Condition<CTX>> factory) {
    ...
    private static class Factory<CTX extends Context> extends AbstractFactory<CTX, CloseInventoryFunction<CTX>> {
        ...
        @Override
        public CloseInventoryFunction<CTX> create(Map<String, Object> arguments) {
