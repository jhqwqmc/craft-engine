            ...
            for (Map.Entry<String, Object> entry : placementMap.entrySet()) {
                ...
                for (Map<String, Object> element : elementConfigs) {
                    FurnitureElement furnitureElement = furnitureElementBuilder()
                            ...
                            .transform(ResourceConfigUtils.getOrDefault(element.getOrDefault("transform", element.get("display-transform")), o -> ItemDisplayContext.valueOf(o.toString().toUpperCase(Locale.ENGLISH)), ItemDisplayContext.NONE))
