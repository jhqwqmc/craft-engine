...
public final class Registries {
    ...
    public static final ResourceKey<Registry<FormulaType>> FORMULA_TYPE = ResourceKey.create(ROOT_REGISTRY, Key.withDefaultNamespace("formula_type"));
    ...
    public static final ResourceKey<Registry<CustomSmithingTransformRecipe.ItemDataProcessor.Type>> SMITHING_RESULT_PROCESSOR_TYPE = ResourceKey.create(ROOT_REGISTRY, Key.withDefaultNamespace("smithing_result_processor_type"));
    public static final ResourceKey<Registry<ResourcePackHostType>> RESOURCE_PACK_HOST_TYPE = ResourceKey.create(ROOT_REGISTRY, Key.withDefaultNamespace("resource_pack_host_type"));
