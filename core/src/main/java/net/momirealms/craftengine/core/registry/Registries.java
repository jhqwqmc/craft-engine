...
public final class Registries {
    ...
    public static final ResourceKey<Registry<ResourcePackHostType>> RESOURCE_PACK_HOST_FACTORY = ResourceKey.create(ROOT_REGISTRY, Key.withDefaultNamespace("resource_pack_host_factory"));
    ...
    public static final ResourceKey<Registry<PlayerSelectorType<?>>> PLAYER_SELECTOR_TYPE = ResourceKey.create(ROOT_REGISTRY, Key.withDefaultNamespace("player_selector_type"));
    public static final ResourceKey<Registry<EquipmentType<?>>> EQUIPMENT_TYPE = ResourceKey.create(ROOT_REGISTRY, Key.withDefaultNamespace("equipment_type"));
    ...
    public static final ResourceKey<Registry<FurnitureElementConfigType<?>>> FURNITURE_ELEMENT_TYPE = ResourceKey.create(ROOT_REGISTRY, Key.withDefaultNamespace("furniture_element_type"));
    public static final ResourceKey<Registry<FurnitureHitboxConfigType<?>>> FURNITURE_HITBOX_TYPE = ResourceKey.create(ROOT_REGISTRY, Key.withDefaultNamespace("furniture_hitbox_type"));
