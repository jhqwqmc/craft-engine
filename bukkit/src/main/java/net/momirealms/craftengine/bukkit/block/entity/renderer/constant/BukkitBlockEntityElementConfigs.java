...
public final class BukkitBlockEntityElementConfigs extends BlockEntityElementConfigs {
    ...
    public static final BlockEntityElementConfigType<BlockDisplayBlockEntityElement> BLOCK_DISPLAY = register(Key.ce("block_display"), BlockDisplayBlockEntityElementConfig.FACTORY);
